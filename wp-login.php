		...
		<form name="loginform" id="loginform" action="http://localhost/myproject/wordpress/wp-login.php" method="post">
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Đăng nhập">
									<input type="hidden" name="redirect_to" value="http://localhost/myproject/wordpress/wp-admin/index.php">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="https://cuongdo1411.github.io/mywordpress/">&larr; Quay lại TRAVELL</a>		</p>
			</div>
...
var userProfileL10n = {"user_id":"0","nonce":"5947e50d5a"};
</script>
